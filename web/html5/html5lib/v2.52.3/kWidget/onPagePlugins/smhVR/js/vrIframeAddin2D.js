...
} else
{
    ...
    loadjscssfiles([('https:' == document.location.protocol ? 'https://' : 'http://') + 'mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/smhVR/css/smhVR.css'], 'css', false);
    loadjscssfiles([('https:' == document.location.protocol ? 'https://' : 'http://') + 'mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/smhVR/js/three.js', ('https:' == document.location.protocol ? 'https://' : 'http://') + 'mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/smhVR/js/OrbitControls.js', ('https:' == document.location.protocol ? 'https://' : 'http://') + "mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/smhVR/js/DeviceOrientationControls.js", ('https:' == document.location.protocol ? 'https://' : 'http://') + "mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/smhVR/js/THREEx.KeyboardState.js", ('https:' == document.location.protocol ? 'https://' : 'http://') + "mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/smhVR/js/StereoEffect.js", ('https:' == document.location.protocol ? 'https://' : 'http://') + "mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/smhVR/js/Detector.js", ('https:' == document.location.protocol ? 'https://' : 'http://') + 'mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/smhVR/js/smh_2d.js'], 'js', runIfNeeded);
        ...
        var callback = function (allmutations) {
            ...
            allmutations.map(function (mr) {
                ...
                if (mr.target.tagName.toLowerCase() === 'video')
                    if (Detector.webgl && !isIOS() && !isSafari() && !isIE()) {
                        setUpCanvas();
                    }
            });
