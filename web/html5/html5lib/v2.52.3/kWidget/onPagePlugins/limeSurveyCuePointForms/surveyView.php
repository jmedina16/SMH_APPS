    ...
    <body style="background-color: #FFFFFF !important; padding: 0 !important;">
        ...
        <script>
            ...
            function getSurveyScriptEmbed(){
                var player_script = '<script>if( !window.jQuery ){document.write(\'<script type="text/javascript" src="http://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/resources/jquery/jquery.min.js"><\\/script>\');}<\/script><div id="smh_survey_player" style="width:'+width+'px;height:'+height+'px;"></div>\
<script src="http://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/mwEmbedLoader.php/partner_id/<?php echo $_GET['pid'] ?>"><\/script>\
<script>\
mw.setConfig(\'Kaltura.EnableEmbedUiConfJs\', true);\
kWidget.embed({\
targetId: "smh_survey_player",\
