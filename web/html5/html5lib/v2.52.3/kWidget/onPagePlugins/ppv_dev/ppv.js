kWidget.addReadyCallback(function (playerId) {
    ...
    ppv.prototype = {
        ...
        showPurchaseWindow: function () {
            ...
            $smh.ajax({
                type: "GET",
                url: protocol + "://mediaplatform.streamingmediahosting.com/apps/ppv/v1.0/dev.php?action=get_tickets",
                data: sessData,
                dataType: 'json',
                beforeSend: function () {
                    ...
                    $smh('.modal-content').html('<div id="ppv-loading"><img width="200px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv_dev/resources/img/loading_icon.gif"></div>');
                }
            }).done(function (msg) {
                ppv_obj.resetModal();
                if (!msg['success']) {
            ...
            if (valid) {
                ...
                $smh.ajax({
                    ...
                    beforeSend: function () {
                        ...
                        $smh('#register-loading').html('<img width="20px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv_dev/resources/img/loading.gif">');
                    }
                }).done(function (data) {
                    if (data['success']) {
                        if (data['auth_key']) {
        ...
        confirm: function () {
            ...
            $smh.ajax({
                type: "GET",
                url: protocol + "://mediaplatform.streamingmediahosting.com/apps/ppv/v1.0/dev.php?action=get_confirm",
                data: sessData,
                dataType: 'json',
                beforeSend: function () {
                    $smh('#smh_purchase_window').modal({
        ...
        pay: function () {
            ...
            $smh.ajax({
                ...
                beforeSend: function () {
                    ...
                    $smh('.modal-dialog').css('width', '520px');
                    $smh('.modal-content').html('<div id="ppv-loading"><img width="200px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv_dev/resources/img/loading_icon.gif">' + text + '</div>');
                    if (gw_type == 1) {
                        if (!isMobile) {
                            var width = 800;
                            var height = 600;
        ...
        changeFname: function (fname) {
            $smh('#settings-tab').html('<div style="float: left;"><button type="button" class="btn btn-default" onclick="ppv_obj.smh_back_settings(); return false;">Back</button></div>' +
                    ...
                    '<div id="result"></div>' +
                    '<span id="btn-loading"><img width="20px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv_dev/resources/img/loading.gif"></span>' +
                    '</div>' +
                    '<div class="clear"></div>' +
                    '</div>' +
                    '</form>');
        ...
        changeEmail: function (email) {
            $smh('#settings-tab').html('<div style="float: left;"><button type="button" class="btn btn-default" onclick="ppv_obj.smh_back_settings(); return false;">Back</button></div>' +
                    ...
                    '<span id="request-btn-loading"><img width="20px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv_dev/resources/img/loading.gif"></span>' +
                    '</div>');
        },
        ...
        authnet: function (data) {
            ...
            var form = $smh('<form action="https://test.authorize.net/gateway/transact.dll" method="post" target="' + target + '">' +
        ...
        paypal: function (order_id, sub_id) {
            ...
            $smh.ajax({
                type: "GET",
                url: protocol + "://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv_dev/resources/php/pptransact.php",
                data: sessData,
                dataType: 'json'
            }).done(function (resp) {
                if (resp.success) {
        ...
        smhLogin: function (pr) {
            ...
            if (valid) {
                ...
                $smh.ajax({
                    ...
                    dataType: 'json',
                    beforeSend: function () {
                        $smh('#login-loading').html('<img width="20px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv_dev/resources/img/loading.gif">');
                    }
                }).done(function (data) {
                    if (data['success']) {
                        if (blocked) {
            ...
            if (valid) {
                ...
                $smh.ajax({
                    ...
                    beforeSend: function () {
                        ...
                        $smh('#loading').html('<img width="20px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv_dev/resources/img/loading.gif">');
                    }
                }).done(function (data) {
                    var header, content;
                    if (data['success']) {
