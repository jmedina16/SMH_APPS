...
mem_init.prototype = {
    ...
    checkAccess: function (pid, sm_ak, uiconf_id, uiconf_width, uiconf_height, entryId, type) {
        ...
        $smh.ajax({
            type: "GET",
            url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=setup_player",
            data: sessData,
            dataType: 'json'
        }).done(function (data) {
            ...
            if (type == 'cl' || type == 'cr' || type == 'ct' || type == 'cb') {
                ...
                $smh.ajax({
                    type: "GET",
                    url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=get_cat_entries",
                    data: sessData,
                    dataType: 'json'
                }).done(function (data) {
                    cat_entries = data;
    ...
    isNotActive: function (pid, sm_ak) {
        ...
        $smh.ajax({
            type: "GET",
            url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=is_not_active",
            data: sessData,
            dataType: 'json'
        });
    },
...
//            }, 1500);
    ...
    loadVideo: function (ks, pid, sm_ak, uiconf_id, uiconf_width, uiconf_height, entryId, type) {
        ...
        if (type == 's') {
            ...
            $smh.ajax({
                type: "GET",
                url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=w_get_thumb",
                data: sessData,
                dataType: 'json'
            }).done(function (data) {
                kWidget.embed({
            ...
            $smh.ajax({
                type: "GET",
                url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=w_get_cat_thumb",
                data: sessData,
                dataType: 'json'
            }).done(function (data) {
                kWidget.embed({
...
function load_Css5() {
    ...
    jqTag.setAttribute("href", mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/css/smh_mem_style.css?v=1.6')
...
function load_Css4() {
    ...
    jqTag.setAttribute("rel", "stylesheet");
    jqTag.setAttribute("type", "text/css");
    jqTag.setAttribute("href", mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/css/tooltipster.css')
...
function load_Css3() {
    ...
    jqTag.setAttribute("rel", "stylesheet");
    jqTag.setAttribute("type", "text/css");
    jqTag.setAttribute("href", mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/css/jquery.dataTables.min.css?v=1.6')
...
function load_Css2() {
    ...
    jqTag.setAttribute("rel", "stylesheet");
    jqTag.setAttribute("type", "text/css");
    jqTag.setAttribute("href", mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/css/font-awesome.min.css')
...
function load_Css1() {
    ...
    jqTag.setAttribute("rel", "stylesheet");
    jqTag.setAttribute("type", "text/css");
    jqTag.setAttribute("href", mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/css/categoryOnPage.css')
...
function load_Js5() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/js/bootstrap.min.js';
...
function load_Js4() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/js/jquery.tooltipster.min.js';
...
function load_Js3() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/js/jstz.min.js';
...
function load_Js2() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/js/jquery.validate.min.js';
...
function load_Js1() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/mem.js?v=1.6';
...
function load_cookies() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/js/jquery.cookie.js';
...
function load_datatables() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = mem_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/js/jquery.dataTables.js?v=1.6';
