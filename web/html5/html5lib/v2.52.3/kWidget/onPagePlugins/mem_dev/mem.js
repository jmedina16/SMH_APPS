    ...
    mem.prototype = {
            ...
            if (valid) {
                ...
                $smh.ajax({
                    ...
                    beforeSend: function () {
                        ...
                        $smh('#register-loading').html('<img width="20px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/img/loading.gif">');
                    }
                }).done(function (data) {
                    if (data['success']) {
                        if (data['auth_key']) {
        ...
        smhLogin: function () {
            ...
            if (valid) {
                ...
                $smh.ajax({
                    type: "GET",
                    url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=login_user",
                    data: sessData,
                    dataType: 'json',
                    beforeSend: function () {
            ...
            if (valid) {
                ...
                $smh.ajax({
                    ...
                    beforeSend: function () {
                        ...
                        $smh('#loading').html('<img width="20px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/img/loading.gif">');
                    }
                }).done(function (data) {
                    var header, content;
                    if (data['success']) {
        ...
        changeEmail: function (email) {
            $smh('#settings-tab').html('<div style="float: left;"><button type="button" class="btn btn-default" onclick="mem_obj.smh_back_settings(); return false;">Back</button></div>' +
                    ...
                    '<span id="request-btn-loading"><img width="20px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/img/loading.gif"></span>' +
                    '</div>');
        },
        ...
        changeFname: function (fname) {
            $smh('#settings-tab').html('<div style="float: left;"><button type="button" class="btn btn-default" onclick="mem_obj.smh_back_settings(); return false;">Back</button></div>' +
                    ...
                    '<div id="result"></div>' +
                    '<span id="btn-loading"><img width="20px" src="' + protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/mem_dev/resources/img/loading.gif"></span>' +
                    '</div>' +
                    '<div class="clear"></div>' +
                    '</div>' +
                    '</form>');
