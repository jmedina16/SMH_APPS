...
var pptransact = function() {
    ...
    return{
        init: function(protocol,mobileFlag){
            ...
            this.url = protocol+"://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.17/kWidget/onPagePlugins/ppv/resources/php/pptransact.php";
        },
        ...
        bill: function(inputArgs) {
            ...
            var data = 'method=getToken&entryId=' + entryId + "&qty=" + qty + "&userId=" + userId + "&mobile=" + this.mobile + "&pid=" + pid + "&ticketId=" + ticketId + "&kentry=" + kentry + "&orderId=" + orderId + "&sm_ak=" + sm_ak + "&type=" + type + "&ticket_type=" + ticket_type + "&bill_per=" + bill_per + "&subId=" + subId + "&protocol=" + protocol;
