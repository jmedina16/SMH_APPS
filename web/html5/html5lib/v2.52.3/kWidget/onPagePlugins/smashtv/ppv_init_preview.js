...
ppv_init.prototype = {
    ...
    loadVideo: function(ks,pid,sm_ak,uiconf_id,uiconf_width,uiconf_height,entryId,type){
        ...
        if(type == 's'){
            $smh('.kWidgetPlayBtn').live('click',function(){
            ...
            flashvars.ppv = {
                ...
                "relativeTo" : "video",
                "position" : "before",                    
                "onPageJs1" : "{onPagePluginPath}/ppv/resources/js/jquery.validate.min.js",
                "onPageJs2" : "{onPagePluginPath}/ppv/resources/js/jstz.min.js",   
                "onPageJs3" : "{onPagePluginPath}/ppv/resources/js/bootstrap.min.js", 
                "requiresJQuery" : true,
                "pid" : pid,
                "sm_ak" : sm_ak,
                "uiConfId" : uiconf_id,
            ...
            if(type == 'cl'){
                layout = 'left'; 
                $smh('.kWidgetPlayBtn').live('click',function(){
                    $smh('#ppv-wrapper').css('width',Number(uiconf_width) + 400); 
                });
            } else if(type == 'cr'){
                layout = 'right';
                $smh('.kWidgetPlayBtn').live('click',function(){
            ...
            flashvars.ppv = {
                ...
                "onPageJs2" : "{onPagePluginPath}/ppv/resources/js/jstz.min.js",   
                "onPageJs3" : "{onPagePluginPath}/ppv/resources/js/bootstrap.min.js", 
                "onPageJs4" : "{onPagePluginPath}/libs/jcarousellite.js",
                "onPageJs5" : "{onPagePluginPath}/libs/jquery.sortElements.js",
                "requiresJQuery" : true,
                "pid" : pid,
                "sm_ak" : sm_ak,
                "uiConfId" : uiconf_id,
...
function load_ppv(){
    ...
    jqTag.src = ppv_protocol+'://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.17/kWidget/onPagePlugins/ppv/ppv.js';
