...
ppv_init.prototype = {
    ...
    checkAccess: function (pid, sm_ak, uiconf_id, uiconf_width, uiconf_height, entryId, type) {
        ...
        if (smh_aff_cookie != '' && smh_aff_cookie != undefined && smh_aff_cookie != null) {
            ...
            if (ppv.$_GET('smh_aff')) {
                ...
                $smh.cookie('smh_aff', ppv.$_GET('smh_aff'), {
                    expires: smh_exp,
                    path: '/'
                });
    ...
    loadCatAssets: function () {
        if (!cat_assets_loaded) {
            ppv.loadCarouselJs();
            cat_assets_loaded = true;
        }
    },
    loadCarouselJs: function () {
        var headTag = document.getElementsByTagName("head")[0];
        var jqTag = document.createElement('script');
        jqTag.type = 'text/javascript';
        jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/libs/jcarousellite.js?v=1.5';
        jqTag.onload = ppv.loadSortJs();
    ...
    loadSortJs: function () {
        ...
        var jqTag = document.createElement('script');
        jqTag.type = 'text/javascript';
        jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/libs/jquery.sortElements.js?v=1.5';
        jqTag.onload = ppv.loadCatCss();
        headTag.appendChild(jqTag);
    },
    loadCatCss: function () {
        var headTag = document.getElementsByTagName("head")[0];
        ...
        jqTag.setAttribute("href", ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/css/categoryOnPage.css?v=1.5');
        headTag.appendChild(jqTag);
    },
    isActive: function (pid, sm_ak) {
        ...
        $smh.ajax({
            type: "GET",
            url: protocol + "://mediaplatform.streamingmediahosting.com/apps/ppv/v1.0/index.php?action=is_active",
            data: sessData,
            dataType: 'json'
        });
    },
    isNotActive: function (pid, sm_ak) {
        ...
        $smh.ajax({
            type: "GET",
            url: protocol + "://mediaplatform.streamingmediahosting.com/apps/ppv/v1.0/index.php?action=is_not_active",
            data: sessData,
            dataType: 'json'
        });
    },
    ...
    fadeLogout: function (kdpId, entryId) {
        ...
        if (!scheduled_is_before && !scheduled_is_after && scheduled_has_end_date && paid) {
            var scheduled_end_date = moment.tz(end_date, user_timezone_name);
            $smh('#clock').countdown(scheduled_end_date.toDate(), function (event) {}).on('finish.countdown', function (event) {
                location.reload();
            });
        }
    },
    ...
    loadPayWallFP: function (kdpId, pid, entryId, thumbId, uiconf_width, uiconf_height) {
        ...
        if (!paid) {
            ...
            if (smh_vr && showCompMessage) {
                $smh('#purchaseWindow').css('height', parseInt($smh('#' + kdpId).css('height')) - 70);
            } else {
            ...
            $smh('#purchaseWindow').show();
            $smh('#purchaseWindow').html(top_bar +
                    '<div id="' + button_id + '">' +
                    '<div id="header">' +
    ...
    loadPayWall: function (kdpId, pid, entryId, thumbId, uiconf_width, uiconf_height) {
        ...
        if (!paid) {
            ...
            if (scheduled_is_before) {
                ...
                $smh('#clock').countdown(scheduled_start_date.toDate(), function (event) {
                    if (countdown) {
                        $smh(this).html(event.strftime(
...
function load_Css4() {
    ...
    jqTag.setAttribute("rel", "stylesheet");
    jqTag.setAttribute("type", "text/css")
    jqTag.setAttribute("href", ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/css/smh_ppv_style.css?v=1.5');
...
function load_Css3() {
    ...
    jqTag.setAttribute("rel", "stylesheet");
    jqTag.setAttribute("type", "text/css")
    jqTag.setAttribute("href", ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/css/tooltipster.css?v=1.5');
...
function load_Css2() {
    ...
    jqTag.setAttribute("rel", "stylesheet");
    jqTag.setAttribute("type", "text/css")
    jqTag.setAttribute("href", ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/css/jquery.dataTables.min.css?v=1.5');
...
function load_Css1() {
    ...
    jqTag.setAttribute("rel", "stylesheet");
    jqTag.setAttribute("type", "text/css")
    jqTag.setAttribute("href", ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/css/font-awesome.min.css?v=1.5');
...
function load_Js8() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/js/bootstrap.min.js?v=1.5';
...
function load_Js7() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/js/jquery.countdown.min.js?v=1.5';
    jqTag.onload = load_Js8;
    headTag.appendChild(jqTag);
}
...
function load_Js6() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/js/moment-timezone-with-data.min.js?v=1.5';
...
function load_Js5() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/js/moment.min.js?v=1.5';
...
function load_Js4() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/js/jquery.tooltipster.min.js?v=1.5';
...
function load_Js3() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/js/jstz.min.js?v=1.5';
...
function load_Js2() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/js/jquery.validate.min.js?v=1.5';
...
function load_Js1() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/ppv.js?v=1.5';
...
function load_html5() {
    ...
    var headTag = document.getElementsByTagName("head")[0];
    var jqTag = document.createElement('script');
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/mwEmbedLoader.php';
...
function load_cookies() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/js/jquery.cookie.js?v=1.5';
...
function load_datatables() {
    ...
    var jqTag = document.createElement('script');
    jqTag.type = 'text/javascript';
    jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/kWidget/onPagePlugins/ppv/resources/js/jquery.dataTables.js?v=1.5';
...
var jqTag = document.createElement('script');
jqTag.type = 'text/javascript';
jqTag.src = ppv_protocol + '://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.52.3/resources/jquery/jquery.min.js?v=1.5';
