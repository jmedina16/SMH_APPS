...
ppv_init.prototype = {
    ...
    loadBaseAssets: function (pid, sm_ak, uiconf_id, uiconf_width, uiconf_height, entryId, type) {
        ...
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/js/jquery.dataTables.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/js/jquery.cookie.js?v=1.6', 'script', 'text/javascript'));
        ...
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/ppv.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/js/jquery.validate.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/js/jstz.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/js/jquery.tooltipster.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/js/moment.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/js/moment-timezone-with-data.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/js/jquery.countdown.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/js/bootstrap.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/css/font-awesome.min.css?v=1.6', 'link', 'text/css'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/css/jquery.dataTables.min.css?v=1.6', 'link', 'text/css'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/css/tooltipster.css?v=1.6', 'link', 'text/css'));
        scriptLibrary.push(new Array(ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/css/smh_ppv_style.css?v=1.6', 'link', 'text/css'));

        ppv.loadJsFilesSequentially(scriptLibrary, 0, function () {
            console.log('SMH DEBUG OUTSIDE');
            //window.onload = function () {
            console.log('SMH DEBUG OUTSIDE JQUERY');
            $(document).ready(function () {
                console.log('SMH DEBUG INSIDE JQUERY');
    ...
    loadCatCss: function (pid) {
        ...
        jqTag.setAttribute("href", ppv_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/ppv/resources/css/categoryOnPage.css?v=1.6');
        headTag.appendChild(jqTag);
    },
