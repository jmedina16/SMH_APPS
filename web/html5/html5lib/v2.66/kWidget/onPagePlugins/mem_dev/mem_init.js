...
mem_init.prototype = {
    ...
    setup: function (pid, sm_ak, uiconf_id, uiconf_width, uiconf_height, entryId, type) {
        ...
        window.smh.ajax({
            type: "GET",
            url: protocol + "://api.mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=setup_player",
            data: sessData,
            dataType: 'json'
        }).done(function (data) {
            ...
            if (type == 'cl' || type == 'cr' || type == 'ct' || type == 'cb') {
                ...
                window.smh.ajax({
                    type: "GET",
                    url: protocol + "://api.mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=get_cat_entries",
                    data: sessData,
                    dataType: 'json'
                }).done(function (data) {
                    cat_entries = data;
            ...
            if (smh_sess == '' || smh_sess == undefined || smh_sess == null) {
                ...
                window.smh.ajax({
                    type: "GET",
                    url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=is_logged_in",
                    data: sessData,
                    dataType: 'json'
                }).done(function (data) {
                    if (data['success']) {
                        ...
                        mem.logoutOnWindowClose(pid, sm_ak);
                    } else {
                        mem.loadVideo('', pid, sm_ak, uiconf_id, uiconf_width, uiconf_height, entryId, type);
                    }
                });
    ...
    logoutOnWindowClose: function (pid, sm_ak) {
        window.addEventListener("beforeunload", function (event) {
            ...
            window.smh.ajax({
                type: "GET",
                url: protocol + "://devplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=is_not_active",
                data: sessData,
                dataType: 'json',
                async: false
            });
    ...
    loadBaseAssets: function (pid, sm_ak, uiconf_id, uiconf_width, uiconf_height, entryId, type) {
        ...
        var scriptLibrary = [];
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/resources/jquery/jquery.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/js/jquery.dataTables.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/js/jquery.cookie.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/sp/' + pid + '00/embedIframeJs/uiconf_id/' + uiconf_id + '/partner_id/' + pid, 'script', 'text/javascript'));
        scriptLibrary.push(new Array(mem_protocol + '://devplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/mem.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/js/jquery.validate.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/js/jstz.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/js/jquery.tooltipster.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/js/bootstrap.min.js?v=1.6', 'script', 'text/javascript'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/css/font-awesome.min.css?v=1.6', 'link', 'text/css'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/css/jquery.dataTables.min.css?v=1.6', 'link', 'text/css'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/css/tooltipster.css?v=1.6', 'link', 'text/css'));
        scriptLibrary.push(new Array(mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/css/smh_mem_style.css?v=1.6', 'link', 'text/css'));
    ...
    loadCarouselJs: function (pid) {
        ...
        jqTag.src = mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/libs/jcarousellite.js?v=1.6';
    ...
    loadSortJs: function (pid) {
        ...
        var jqTag = document.createElement('script');
        jqTag.type = 'text/javascript';
        jqTag.src = mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/libs/jquery.sortElements.js?v=1.6';
    ...
    loadCatCss: function (pid) {
        ...
        jqTag.setAttribute("href", mem_protocol + '://apps.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/css/categoryOnPage.css?v=1.6');
        headTag.appendChild(jqTag);
    },
    isActive: function (pid, sm_ak, userId) {
        ...
        window.smh.ajax({
            type: "GET",
            url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=is_active",
            data: sessData,
            dataType: 'json'
        });
    },
    ...
    fadeLogout: function (kdpId, entryId) {
        ...
        window.smh('#myVideoContainer').css('position', 'relative');
        window.smh('#myVideoContainer').css('top', '40px');
        //mem.endResize();
...
//        });
    ...
    loadWall: function (kdpId, pid, entryId, thumbId, uiconf_width, uiconf_height) {
        ...
        if (!is_logged_in) {
            window.smh('#myVideoContainer').css('position', '');
            window.smh('#myVideoContainer').css('top', '');
            window.smh('#memWindow').css('top', window.smh('#' + kdpId).position().top);
            window.smh('#memWindow').css('left', window.smh('#' + kdpId).position().left);
            window.smh('#memWindow').css('width', parseInt(window.smh('#' + kdpId).css('width')));
