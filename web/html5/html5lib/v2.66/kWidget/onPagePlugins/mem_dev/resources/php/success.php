    ...
    <head>
        ...
        <script>
            ...
            function closeFlow(param) {
                var mobile = <?= $data[10] ?>;
                if(mobile){
                    $('#loading').html('<img width="500px" src="http://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.26/kWidget/onPagePlugins/ppv_dev/resources/img/loading_icon.gif"><div style="font-size: 38px; text-align: center;">Please wait while we complete your transaction..</div>');
                    checkInventory();
