kWidget.addReadyCallback(function (playerId) {
    ...
    mem.prototype = {
        ...
        register: function () {
            ...
            if (valid) {
                ...
                window.smh.ajax({
                    type: "GET",
                    url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=register_account",
                    data: sessData,
                    dataType: 'json',
                    beforeSend: function () {
                        window.smh('#register-button').attr('disabled', '');
                        window.smh('#register-loading').html('<img width="20px" src="' + protocol + '://images.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/img/loading.gif">');
                    }
                }).done(function (data) {
                    if (data['success']) {
                        if (data['auth_key']) {
                            ...
                            window.mem.logoutOnWindowClose(pid, sm_ak);
                            ...
                            setTimeout(function () {
                                ...
                                window.smh('#smh_mem_window').modal('hide');
                            }, 5000);
                            mem_obj.regConfForm();
                        } else {
        ...
        activateForm: function (email) {
            ...
            window.smh('#smh_mem_window .modal-header').html(header);
            ...
            content = '<div id="pass-instructions">Thank you for registering! A confirmation email has been sent to:<br><br> <strong>' + email + '</strong>.<br><br> Please click on the activation link in the email to activate your account. If you did not receive an email, please check your spam.</div>' +
                    ...
                    '</div>' +
                    '<div class="clear"></div>';
            window.smh('#smh_mem_window .modal-body').html(content);
        },
        ...
        login_register_form: function () {
            var header, content;
            window.smh('#smh_mem_window').modal({
                backdrop: 'static'
            });
        ...
        resetModal: function () {
            window.smh('#smh_mem_window .modal-content').html('<div class="modal-header"></div><div class="modal-body"></div>');
        },
        login_form: function () {
            mem_obj.resetModal();
            var header, content;
        ...
        smhLogin: function () {
            ...
            if (valid) {
                ...
                window.smh.ajax({
                    type: "GET",
                    url: protocol + "://devplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=login_user",
                    data: sessData,
                    dataType: 'json',
                    beforeSend: function () {
                        window.smh('#login-loading').html('<img width="20px" src="' + protocol + '://images.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem/resources/img/loading.gif">');
                    }
                }).done(function (data) {
                    if (data['success']) {
                        if (blocked) {
                        ...
                        window.smh('.modal-content').html('<div id="mem-loading"><img width="200px" src="' + protocol + '://images.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem/resources/img/loading_icon.gif"></div>');
        ...
        smhLogout: function (entryId) {
            ...
            window.smh("#memWindow").stop(true, true).fadeOut();
            window.smh('#memWindow').stop(true, false).fadeIn();
            ...
            window.smh(document).unbind('touchmove');
        ...
        pass_reset_form: function () {
            ...
            if (valid) {
                ...
                window.smh.ajax({
                    type: "GET",
                    url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=reset_request",
                    data: sessData,
                    dataType: 'json',
                    beforeSend: function () {
                        window.smh('#pass-submit').attr('disabled', '');
                        window.smh('#loading').html('<img width="20px" src="' + protocol + '://images.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/img/loading.gif">');
                    }
                }).done(function (data) {
                    var header, content;
                    if (data['success']) {
        ...
        smh_back_settings: function () {
            ...
            window.smh.ajax({
                type: "GET",
                url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=get_user_details",
                data: sessData,
                dataType: 'json'
            }).done(function (data) {
                window.smh('#settings-tab').html('<div class="profile-row">' +
                        '<span class="profile-option">First Name</span><span class="profile-change" onclick="mem_obj.changeFname(\'' + data['fname'] + '\',' + pid + ');">Change</span>' +
                        '<div class="clear"></div>' +
                        '</div>' +
                        '<div class="profile-value">' + data['fname'] + '</div>' +
                        '<div class="profile-row">' +
                        '<span class="profile-option">Last Name</span><span class="profile-change" onclick="mem_obj.changeLname(\'' + data['lname'] + '\',' + pid + ');">Change</span>' +
                        '<div class="clear"></div>' +
                        '</div>' +
                        '<div class="profile-value">' + data['lname'] + '</div>' +
                        '<div class="profile-row">' +
                        '<span class="profile-option">Email</span><span class="profile-change" onclick="mem_obj.changeEmail(\'' + data['email'] + '\',' + pid + ');">Change</span>' +
                        '<div class="clear"></div>' +
                        '</div>' +
                        '<div class="profile-value">' + data['email'] + '</div>' +
                        '<div class="profile-row">' +
                        '<span class="profile-option">Password</span><span class="profile-change" onclick="mem_obj.changePsswd(\'' + data['email'] + '\',' + pid + ');">Change</span>' +
                        '<div class="clear"></div>' +
                        '</div>' +
        ...
        changeEmail: function (email, pid) {
            window.smh('#settings-tab').html('<div style="float: left;"><button type="button" class="btn btn-default" onclick="mem_obj.smh_back_settings(); return false;">Back</button></div>' +
                    '<div class="clear"></div>' +
                    '<div id="smh-request">' +
                    ...
                    '<span id="request-btn-loading"><img width="20px" src="' + protocol + '://images.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/img/loading.gif"></span>' +
                    '</div>');
        },
        ...
        updateEmail: function (email) {
            ...
            window.smh.ajax({
                type: "GET",
                url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=reset_email_request",
                data: sessData,
                dataType: 'json',
                beforeSend: function () {
        ...
        updatePassword: function (email) {
            ...
            window.smh.ajax({
                type: "GET",
                url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=reset_psswd_request",
                data: sessData,
                dataType: 'json',
                beforeSend: function () {
                    window.smh('#request-btn-loading').css('display', 'inline');
        ...
        changeFname: function (fname, pid) {
            window.smh('#settings-tab').html('<div style="float: left;"><button type="button" class="btn btn-default" onclick="mem_obj.smh_back_settings(); return false;">Back</button></div>' +
                    ...
                    '<div id="result"></div>' +
                    '<span id="btn-loading"><img width="20px" src="' + protocol + '://images.mediaplatform.streamingmediahosting.com/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/mem_dev/resources/img/loading.gif"></span>' +
                    '</div>' +
                    '<div class="clear"></div>' +
                    '</div>' +
                    '</form>');
        ...
        updateFname: function () {
            ...
            if (valid) {
                ...
                window.smh.ajax({
                    type: "GET",
                    url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=update_fname",
                    data: sessData,
                    dataType: 'json',
                    beforeSend: function () {
                    ...
                    if (data['success']) {
                        window.smh('#smh_mem_window #result').html('<span class="label label-success">Successfully Updated!</span>');
                        setTimeout(function () {
                            window.smh('#smh_mem_window #result').empty();
                            window.smh('#update').removeAttr('disabled');
                        }, 3000);
                    } else {
                        window.smh('#smh_mem_window #result').html('<span class="label label-danger">Error, could not update!</span>');
                        setTimeout(function () {
                            window.smh('#smh_mem_window #result').empty();
                            window.smh('#update').removeAttr('disabled');
                        }, 3000);
        ...
        updateLname: function () {
            ...
            if (valid) {
                ...
                window.smh.ajax({
                    type: "GET",
                    url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=update_lname",
                    data: sessData,
                    dataType: 'json',
                    beforeSend: function () {
                        window.smh('#btn-loading').css('display', 'block');
        ...
        setupCat: function (pid, sm_ak, entryId) {
            ...
            window.smh.ajax({
                type: "GET",
                url: protocol + "://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=activate_cat_entry",
                data: sessData,
                dataType: 'json'
            }).done(function (data) {
                if (!data) {
    ...
    window['freePreviewEndHandler'] = function () {
        ...
        if (mem_type == 'p') {
            ...
            window.smh.ajax({
                type: "GET",
                url: protocol + "://api.mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=w_get_thumb",
                data: sessData,
                dataType: 'json'
            }).done(function (data) {
            ...
            window.smh.ajax({
                type: "GET",
                url: protocol + "://api.mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=w_get_cat_thumb",
                data: sessData,
                dataType: 'json'
            }).done(function (data) {
                window.mem.loadWall(playerId, pid, entryId, data, uiconf_width, uiconf_height);
