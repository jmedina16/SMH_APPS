...
function showEditor(){                        
    ...
    $('#mirosubsAPI').remove();
    $('head').append('<script src="/html5/html5lib/v2.66/kWidget/onPagePlugins/miroSubsOnPage/mirosubs/mirosubs-api.min.js" id="mirosubsAPI" type="text/javascript"><\/script>');
    subtitles = [];
...
function getBasePath(){
    return 'https://mediaplatform.streamingmediahosting.com/html5/html5lib/v2.66/kWidget/onPagePlugins/miroSubsOnPage/mirosubs/';
}
