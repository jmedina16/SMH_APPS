...
} else
{
    ...
    var cache_path = 'devplatform.streamingmediahosting.com';
    var pid = 0;
    if (CDN_CACHE) {
        var cdn_cache = CDN_CACHE;
        if (cdn_cache === 'hw') {
    ...
    loadjscssfiles([('https:' == document.location.protocol ? 'https://' : 'http://') + cache_path + '/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/smhVR/css/smhVR.css'], 'css', false);
    loadjscssfiles([('https:' == document.location.protocol ? 'https://' : 'http://') + cache_path + '/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/smhVR/js/three.min.js', ('https:' == document.location.protocol ? 'https://' : 'http://') + cache_path + '/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/smhVR/js/OrbitControls.js', ('https:' == document.location.protocol ? 'https://' : 'http://') + cache_path + '/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/smhVR/js/DeviceOrientationControls.js', ('https:' == document.location.protocol ? 'https://' : 'http://') + cache_path + '/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/smhVR/js/THREEx.KeyboardState.js', ('https:' == document.location.protocol ? 'https://' : 'http://') + cache_path + '/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/smhVR/js/StereoEffect.js', ('https:' == document.location.protocol ? 'https://' : 'http://') + cache_path + '/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/smhVR/js/Detector.js', ('https:' == document.location.protocol ? 'https://' : 'http://') + cache_path + '/p/' + pid + '/html5/html5lib/v2.66/kWidget/onPagePlugins/smhVR/js/smh_2d.js'], 'js', runIfNeeded);
    ...
    (function (mw, $) {
        ...
        mw.addKalturaConfCheck(function (embedPlayer, callback) {
            ...
            if (!isIOS() && !isSafari() && !isIE() && !isSafari() && !isEdge()) {
