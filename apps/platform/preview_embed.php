...
<html>
    ...
    <?php } ?>
            ...
            var player = getPlayerEmbed(<?php echo $_GET['pid'] ?>,"<?php echo $_GET['sm_ak'] ?>",<?php echo $_GET['uiconf_id'] ?>,<?php echo $_GET['width'] ?>,<?php echo $_GET['height'] ?>,"<?php echo $_GET['entry_id'] ?>","<?php echo $_GET['mode'] ?>", ppv_protocol_prev);
            $smh('#embed_code').val(player);
            ...
            <div class="content">
                ...
                <div class="player_preview">Preview Player<hr>
                    <div style="overflow-y: auto; height: 555px;">
                        <div id="myVideoContainer"></div><div id="purchaseWindow" style="display: none;"></div>
                    </div>
                </div>
            </div>
